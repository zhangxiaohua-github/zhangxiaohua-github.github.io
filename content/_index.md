  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        - Echo Simulation and SAR Image Focusing: Utilizing imaging algorithms to process Level-0 data into Level-1 products;

        - SAR Image Processing and Microwave Remote Sensing: Development of SAR image filtering and segmentation algorithms, coupled with soil moisture inversion using the Water Cloud Model;

        - InSAR Applications: Quantifying and monitoring surface deformation rates through InSAR technology.
